...
public class DomainErrors : BaseError
{
    ...
    public static readonly Error InvalidDatesForReescheduling = Create("INVALID_DATES_FOR_REESCHEDULING", "Cannot reeschedule an activity with a start date greather than end date");

    public static readonly Error InvalidWorkersForReescheduling = Create("INVALID_WORKERS_FOR_REESCHEDULING", "Workers to reeschedule activity does not match to original assignment.");
}
